...
export declare class VoicesClient {
     ...
     *     })
     */
    list(request: Hume.tts.VoicesListRequest, requestOptions?: VoicesClient.RequestOptions): Promise<core.Page<Hume.tts.ReturnVoice, Hume.tts.ReturnPagedVoices>>;
    /**
     ...
     *     })
     */
    create(request: Hume.tts.PostedVoice, requestOptions?: VoicesClient.RequestOptions): core.HttpResponsePromise<Hume.tts.ReturnVoice>;
    private __create;
    /**
     ...
     *     })
     */
    delete(request: Hume.tts.VoicesDeleteRequest, requestOptions?: VoicesClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
}
