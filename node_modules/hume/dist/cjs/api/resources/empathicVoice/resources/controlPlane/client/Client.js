...
class ControlPlaneClient {
    ...
    __send(chatId, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v0/evi/chat/{chat_id}/send");
        });
    }
    connect(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Socket_js_1.ControlPlaneSocket({ socket });
        });
    }
