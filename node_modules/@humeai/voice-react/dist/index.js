...
var useSoundPlayer = (props) => {
  ...
  const initPlayer = (0, import_react3.useCallback)(
    async (speakerDeviceId) => {
...
var useVoiceClient = (props) => {
  ...
  const onSessionSettings = (0, import_react4.useRef)(
...
var useMessages = ({
  ...
  const createSessionSettingsMessage = (0, import_react6.useCallback)(
    (sessionSettings) => {
      setMessages(
        (prev) => prev.concat([
          {
...
var VoiceProvider = ({
  ...
  const client = useVoiceClient({
    ...
    onSessionSettings: (0, import_react8.useCallback)(
      (sessionSettings) => {
        if (checkIsDisconnecting() || checkIsDisconnected()) {
          return;
        }
...
// src/lib/messages.ts
var HumeSerialization = __toESM(require("hume/serialization"));
